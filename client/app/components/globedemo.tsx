...
import { Position } from "@/app/components/globe";
  ...
  return (
    <div className="relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden md:h-[40rem] px-4">
        ...
        <div className="absolute w-full bottom-0 inset-x-0 pointer-events-none select-none from-transparent dark:to-black to-white z-40" />
        <div className="w-full md:h-full z-10">
